import sys; sys.path.append('../../repos/jimmyg/')
...
bbox = BBox('data.db')
data = Data('/Users/datapress/Desktop/datapress/MyLondon/data.db')
postcode = Postcode()
geometry = Geometry(shared.ExistingDirectory('/Users/datapress/Desktop/datapress/MyLondon/UK-GeoJSON/json/statistical/eng/oa_by_lsoa/'))
...
class HttpRequestHandler(aiohttp.server.ServerHttpProtocol):
    ...
    def handle_request(self, message, payload):
        ...
        elif url.path.startswith('/lsoa/'):
            body = yield from geometry.api(url.path[6:])
            response.add_header('Content-Type', 'application/json')
        else:
            body = b'not found'
